    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            <div class="auth-card-body">
                ...
                <!-- Reset Form -->
                <form method="POST" action="<?php echo e(route('password.email')); ?>" class="auth-form" id="resetForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>