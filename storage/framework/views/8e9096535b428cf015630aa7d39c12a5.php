        ...
        <div class="stat-card-modern fade-in stagger-1">
            ...
            <div class="stat-content">
                ...
                <div class="stat-change">
                    ...
                    <?php echo e($activities->lastPage()); ?> pages
                </div>
            </div>
        </div>
            ...
            <div class="stat-content">
                ...
                <div class="stat-change <?php echo e(isset($weeklyChange) && $weeklyChange > 0 ? 'positive' : ''); ?>">
                    <?php if(isset($weeklyChange)): ?>
                        ...
                        <?php echo e(abs($weeklyChange)); ?>% vs semaine dernière
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <form method="GET" action="<?php echo e(route('activity.index')); ?>" id="filterForm">
            <div class="filter-grid">
                ...
                <div class="form-group-modern">
                    ...
                    <input type="date" name="date_from" class="form-control-modern" value="<?php echo e(request('date_from')); ?>">
                </div>
                
                <div class="form-group-modern">
                    <label class="form-label-modern">Date de fin</label>
                    <input type="date" name="date_to" class="form-control-modern" value="<?php echo e(request('date_to')); ?>">
                </div>
                ...
                <div class="form-group-modern">
                    ...
                    <input type="text" name="search" class="form-control-modern" 
                           placeholder="Description..." value="<?php echo e(request('search')); ?>">
                </div>
            </div>
            ...
            <div class="filter-actions">
                ...
                <a href="<?php echo e(route('activity.index')); ?>" class="btn-modern btn-outline-modern">
                ...
                <div class="dropdown-modern ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('activity.export', ['format' => 'csv'])); ?>"><i class="fas fa-file-csv me-2"></i>CSV</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('activity.export', ['format' => 'json'])); ?>"><i class="fas fa-file-code me-2"></i>JSON</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('activity.export', ['format' => 'pdf'])); ?>"><i class="fas fa-file-pdf me-2"></i>PDF</a></li>
                    </ul>
                </div>
            </div>
        </form>
        ...
        <?php if(request()->anyFilled(['user_id', 'event', 'date_from', 'date_to', 'search', 'subject_type'])): ?>
            <div class="filter-badge mt-4">
                ...
                <span>
                    ...
                    <?php if(request('event')): ?> <?php echo e(request('event')); ?> · <?php endif; ?>
                    <?php if(request('date_from')): ?> dès <?php echo e(request('date_from')); ?> · <?php endif; ?>
                    <?php if(request('date_to')): ?> jusqu'au <?php echo e(request('date_to')); ?> · <?php endif; ?>
                    <?php if(request('search')): ?> "<?php echo e(request('search')); ?>" · <?php endif; ?>
                    <?php if(request('subject_type')): ?> <?php echo e(class_basename(request('subject_type'))); ?> · <?php endif; ?>
                    <?php echo e($activities->total()); ?> résultat(s)
                </span>
                <a href="<?php echo e(route('activity.index')); ?>" class="btn-icon-modern" style="width: auto; padding: 0 8px;">
            ...
            <table class="table-modern">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            <td>
                                <span class="badge-modern badge-secondary">#<?php echo e(($activities->currentPage() - 1) * $activities->perPage() + $loop->iteration); ?></span>
                            </td>
                            
                            <td>
                                <div style="font-weight: 500; color: var(--gray-800);"><?php echo e($activity->created_at->format('d/m/Y')); ?></div>
                                <div style="font-size: 0.75rem; color: var(--gray-500);"><?php echo e($activity->created_at->format('H:i:s')); ?></div>
                            </td>
                            
                            <td>
                                <div style="font-weight: 500; color: var(--gray-800); margin-bottom: 4px;"><?php echo e($activity->description); ?></div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-modern" style="width: 32px; height: 32px;">
                                            <?php if($activity->causer->avatar): ?>
                                                <img src="<?php echo e(asset('storage/' . $activity->causer->avatar)); ?>" alt="<?php echo e($activity->causer->name); ?>">
                                            <?php else: ?>
                                                <i class="fas fa-user"></i>
                                            <?php endif; ?>
                                        </div>
                                        <div>
                                            <div style="font-weight: 500; color: var(--gray-800);"><?php echo e($activity->causer->name); ?></div>
                                            <div style="font-size: 0.688rem; color: var(--gray-500);"><?php echo e($activity->causer->email); ?></div>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="d-flex align-items-center gap-2">
                            ...
                            <td>
                                ...
                                <?php if($activity->subject && method_exists($activity->subject, 'getNameAttribute')): ?>
                                    <div style="font-size: 0.688rem; color: var(--gray-500); margin-top: 4px;">
                                        <?php echo e($activity->subject->getNameAttribute()); ?>
                            ...
                            <td>
                                <span class="badge-modern <?php echo e($eventColor); ?>">
                ...
                <nav>
                    <ul class="pagination-modern">
                        ...
                        <li class="page-item <?php echo e($activities->onFirstPage() ? 'disabled' : ''); ?>">
                            <a class="page-link" href="<?php echo e($activities->url(1)); ?>" title="Première page">
                        ...
                        <!-- Page précédente -->
                        <li class="page-item <?php echo e($activities->onFirstPage() ? 'disabled' : ''); ?>">
                            <a class="page-link" href="<?php echo e($activities->previousPageUrl()); ?>" title="Page précédente">
                        ...
                        <li class="page-item <?php echo e(!$activities->hasMorePages() ? 'disabled' : ''); ?>">
                            <a class="page-link" href="<?php echo e($activities->nextPageUrl()); ?>" title="Page suivante">
                        ...
                        <!-- Dernière page -->
                        <li class="page-item <?php echo e(!$activities->hasMorePages() ? 'disabled' : ''); ?>">
                            <a class="page-link" href="<?php echo e($activities->url($last)); ?>" title="Dernière page">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert-modern alert-info">
                            ...
                            <div>
                                ...
                                <?php echo e($activities->total()); ?> logs seront analysés.
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
