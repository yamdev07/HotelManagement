...
<div class="detail-page">
    ...
    <div class="alert-status alert-status-reservation">
        ...
        <div>
            ...
            <p class="mb-0 small">Arrivée prévue : <strong><?php echo e(\Carbon\Carbon::parse($transaction->check_in)->format('d/m/Y à H:i')); ?></strong></p>
        </div>
    </div>
    ...
    <div class="alert-status alert-status-active">
        ...
        <div>
            ...
            <p class="mb-0 small">Départ prévu : <strong><?php echo e(\Carbon\Carbon::parse($transaction->check_out)->format('d/m/Y à H:i')); ?></strong>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="detail-value">
                                ...
                                <span class="text-muted ms-2"><?php echo e(\Carbon\Carbon::parse($transaction->check_in)->format('H:i')); ?></span>
                            </p>
                        </div>
                        <div class="col-md-6">
                            ...
                            <p class="detail-value">
                                ...
                                <span class="text-muted ms-2"><?php echo e(\Carbon\Carbon::parse($transaction->check_out)->format('H:i')); ?></span>
                            </p>
                        </div>
                    </div>
