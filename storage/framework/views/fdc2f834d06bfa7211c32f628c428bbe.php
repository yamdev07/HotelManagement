...
<?php $__env->startSection('title', 'Restaurant Gastronomique — Cactus Palace 5 Étoiles'); ?>
        ...
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <div class="mt-4" data-aos="fade-up" data-aos-delay="40">
                    <a href="<?php echo e(route('frontend.african')); ?>"
            ...
            <div class="row g-4" id="menuList">
                ...
                <div class="col-lg-6 menu-item"
                     data-category="<?php echo e($menu->category); ?>"
                     data-aos="fade-up" data-aos-delay="<?php echo e(($loop->index % 4) * 60); ?>">
                    <div class="menu-card">
                        <?php if($menu->image): ?>
                        ...
                        <div class="menu-card-body">
                            <div class="menu-card-header">
                                <div class="menu-card-name"><?php echo e($menu->name); ?></div>
                                <div class="menu-card-price"><?php echo e(number_format($menu->price, 0, ',', ' ')); ?> FCFA</div>
                            </div>
                            <p class="menu-card-desc"><?php echo e($menu->description); ?></p>
                            <div class="menu-card-footer">
                                <span class="cat-badge">
                                    <?php if($menu->category == 'plat'): ?> Plat
                ...
                <div class="om-body">
                    ...
                    <div class="om-panel" id="panel-2">
                        ...
                        <div class="om-menu-grid" id="om-menu-grid">
                            ...
                            <div class="om-dish" data-cat="<?php echo e($menu->category); ?>"
                                ...
                                <div class="om-dish-body">
                                    <div class="om-dish-name"><?php echo e($menu->name); ?></div>
                                    <?php if($menu->description): ?>
                                    <div class="om-dish-desc"><?php echo e(Str::limit($menu->description, 60)); ?></div>
                                    <?php endif; ?>
                                    <div class="om-dish-footer">
                                        <span class="om-dish-price"><?php echo e(number_format($menu->price, 0, ',', ' ')); ?> FCFA</span>
                                        <div class="om-qty" id="qty-<?php echo e($menu->id); ?>" style="display:none">
                                            <button type="button" class="om-qty-btn om-qty-minus" data-id="<?php echo e($menu->id); ?>">−</button>
                                            <span class="om-qty-val" id="qval-<?php echo e($menu->id); ?>">0</span>
                                            <button type="button" class="om-qty-btn om-qty-plus" data-id="<?php echo e($menu->id); ?>">+</button>
                                        </div>
                                        <button type="button" class="om-add-btn" id="addbtn-<?php echo e($menu->id); ?>" data-id="<?php echo e($menu->id); ?>">
                                            + Ajouter
                                        </button>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    $('#reservationForm').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo e(route("restaurant.reservation.store")); ?>', type:'POST', data:$(this).serialize(),
            success: function() {
...
<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\HotelManagement\resources\views/frontend/pages/restaurant.blade.php ENDPATH**/ ?>