            ...
            <div class="col-xl-3 col-lg-4 col-md-6 menu-item" data-category="<?php echo e($menu->category); ?>">
                <div class="card menu-card mb-4 border">
                    <div class="position-relative">
                        <?php if($menu->image): ?>
                        <img src="<?php echo e($menu->image_url); ?>" class="card-img-top" alt="<?php echo e($menu->name); ?>" style="height: 200px; object-fit: cover;">
                        <?php else: ?>
...
<div class="modal fade" id="orderModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content nom-card">
            ...
            <form action="<?php echo e(route('restaurant.orders.store')); ?>" method="POST" id="orderForm">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="nom-field">
                            ...
                            <select class="nom-input nom-select" id="sel-client">
                                ...
                                <option value="<?php echo e($c->id); ?>" data-name="<?php echo e($c->name); ?>"
                                    ...
                                    <?php echo e($c->name); ?><?php echo e(!empty($c->room_number) ? ' — Ch. '.$c->room_number : ''); ?>
                        ...
                        <div class="nom-dish" data-cat="<?php echo e($menu->category); ?>"
                            ...
                            <div class="nom-dish-body">
                                ...
                                <div class="nom-dish-footer">
                                    ...
                                    <div class="nom-qty" id="qty-<?php echo e($menu->id); ?>" style="display:none">
                                        <button type="button" class="nom-qty-btn qminus" data-id="<?php echo e($menu->id); ?>">−</button>
                                        <span class="qval" id="qval-<?php echo e($menu->id); ?>">0</span>
                                        <button type="button" class="nom-qty-btn qplus" data-id="<?php echo e($menu->id); ?>">+</button>
                                    </div>
                                    <button type="button" class="nom-add-btn" id="addbtn-<?php echo e($menu->id); ?>" data-id="<?php echo e($menu->id); ?>">
...
$(document).ready(function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            fetch(`<?php echo e(url('restaurant/menus')); ?>/${menuId}`, {
                method: 'POST',
                headers: {
                ...
                body: `_method=DELETE&_token=<?php echo e(csrf_token()); ?>`
            })
            .then(res => res.json())
            .then(data => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\HotelManagement\resources\views/restaurant/index.blade.php ENDPATH**/ ?>