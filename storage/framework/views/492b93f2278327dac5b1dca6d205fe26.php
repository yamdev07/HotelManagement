...
<?php $__env->startSection('title', 'Détails de la Chambre'); ?>
...
<div class="details-page">
    ...
    <div class="details-breadcrumb anim-1">
        ...
        <span class="sep"><i class="fas fa-chevron-right fa-xs"></i></span>
        <span class="current">Chambre <?php echo e($room->number); ?></span>
    </div>
                ...
                <div class="details-card-body">
                    ...
                    <div class="guest-info">
                        <div class="guest-info-item">
                            ...
                            <div class="guest-info-text"><?php echo e($customer->user->email); ?></div>
                        </div>
                        <div class="guest-info-item">
                            <div class="guest-info-icon"><i class="fas fa-briefcase"></i></div>
                            <div class="guest-info-text"><?php echo e($customer->job ?? 'Non spécifié'); ?></div>
                        </div>
                        <div class="guest-info-item">
                            <div class="guest-info-icon"><i class="fas fa-map-marker-alt"></i></div>
                            <div class="guest-info-text"><?php echo e($customer->address ?? 'Non spécifié'); ?></div>
                        </div>
                        <div class="guest-info-item">
                            <div class="guest-info-icon"><i class="fas fa-phone"></i></div>
                            <div class="guest-info-text"><?php echo e($customer->phone ?? 'Non spécifié'); ?></div>
                        </div>
                        <?php if($customer->birthdate): ?>
                        <div class="guest-info-item">
                            <div class="guest-info-icon"><i class="fas fa-birthday-cake"></i></div>
                            <div class="guest-info-text"><?php echo e(\Carbon\Carbon::parse($customer->birthdate)->format('d/m/Y')); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="details-card-body">
                        ...
                        <div class="info-card">
                            ...
                            <div>
                                <span class="badge badge--<?php echo e($room->roomStatus->color ?? 'gray'); ?>">
                                    <i class="fas fa-<?php echo e($room->status_icon ?? 'door-closed'); ?> me-1"></i>
                    ...
                    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:16px">
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                ...
                                <div class="stat-value"><?php echo e(number_format($room->price, 0, ',', ' ')); ?></div>
                    ...
                    <div class="stat-card" style="margin-bottom:12px">
                        ...
                        <div>
                            ...
                            <div class="stat-value" style="font-size:.9rem"><?php echo e($room->view); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('image.store', ['room' => $room->id])); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="margin-bottom:16px">
                        ...
                        <input type="file" 
                               class="form-control-db <?php $__errorArgs = ['image'];
...
<?php if(session('failed')): ?>
    toastr.error("<?php echo e(session('failed')); ?>", "Erreur");
<?php endif; ?>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    toastr.error("<?php echo e($message); ?>", "Upload échoué");
