...
<div class="search-page">
    ...
    <div class="page-header anim-2">
        ...
        <a href="<?php echo e(route('checkin.index')); ?>" class="btn btn-gray">
        ...
        <div class="card-body">
            ...
            <?php elseif($reservations->isEmpty()): ?>
                ...
                <div class="empty-state">
                    ...
                    <p>Aucune réservation ne correspond à "<?php echo e($search); ?>"</p>
                    <div class="d-flex gap-2 justify-content-center">
                        <a href="<?php echo e(route('checkin.search')); ?>" class="btn btn-gray">Nouvelle recherche</a>
                        <a href="<?php echo e(route('checkin.direct')); ?>" class="btn btn-green">Check-in direct</a>
                    </div>
                </div>
                    ...
                    <?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="reservation-item">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <h6 class="fw-semibold mb-2"><?php echo e($transaction->customer->name); ?></h6>
                            ...
                            <div class="row mt-3 pt-3" style="border-top:1px solid var(--gray-200);">
                                ...
                                <div class="col-md-4">
                                    <small class="text-muted">
                                        ...
                                        <strong>Total:</strong> <?php echo e(number_format($totalPrice, 0, ',', ' ')); ?> FCFA
                                    </small>
                                </div>
                                <div class="col-md-4">
                                    <small class="text-muted">
                                        <i class="fas fa-credit-card me-1" style="color:var(--green-600);"></i>
                                        <strong>Payé:</strong> <?php echo e(number_format($totalPaid, 0, ',', ' ')); ?> FCFA
                                        <?php if($remaining > 0): ?>
                                            <span class="text-danger ms-1">
                                                (Solde: <?php echo e(number_format($remaining, 0, ',', ' ')); ?>)
                                            </span>
                                        <?php endif; ?>
                                    </small>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('checkin.direct')); ?>" class="btn btn-green">
...
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/checkin/search.blade.php ENDPATH**/ ?>