<?php $__env->startSection('title', 'Restaurant - Suivi des Ventes'); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 text-primary fw-bold"><?php echo e(number_format($totalRevenue, 0, ',', ' ')); ?></h3>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 text-success fw-bold"><?php echo e(number_format($todayRevenue, 0, ',', ' ')); ?></h3>
                        <small class="text-muted">FCFA</small>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 text-info fw-bold"><?php echo e(number_format($monthRevenue, 0, ',', ' ')); ?></h3>
                        <small class="text-muted">FCFA</small>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 text-warning fw-bold"><?php echo e(number_format($totalOrders, 0, ',', ' ')); ?></h3>
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $topItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <?php if($i === 0): ?>
                                ...
                                <td><strong><?php echo e($item->menu->name ?? '—'); ?></strong></td>
                                <td>
                                    <?php if($item->menu): ?>
                                    <span class="badge bg-light text-dark border"><?php echo e(ucfirst($item->menu->category)); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                    <span class="badge bg-primary rounded-pill"><?php echo e($item->total_qty); ?></span>
                                </td>
                                <td class="text-end fw-semibold">
                                    <?php echo e(number_format($item->total_revenue, 0, ',', ' ')); ?> FCFA
                                </td>
                            </tr>
...
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\HotelManagement\resources\views/restaurant/sales.blade.php ENDPATH**/ ?>