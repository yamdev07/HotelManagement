...
<div class="av-page">
    ...
    <div class="page-header anim-2">
        ...
        <div class="header-actions">
            <a href="<?php echo e(route('availability.calendar')); ?>" class="btn btn-gray">
                <i class="fas fa-calendar-alt"></i> Calendrier
            </a>
            <a href="<?php echo e(route('availability.inventory')); ?>" class="btn btn-gray">
    ...
    <div class="search-card anim-3">
        <div class="search-card-body">
            <form method="GET" action="<?php echo e(route('availability.search')); ?>">
                <div class="search-grid">
                    <div class="form-group">
                        <label class="form-label">Arrivée</label>
                        <input type="date" name="check_in" class="form-control" 
                               value="<?php echo e($checkIn); ?>" min="<?php echo e(now()->format('Y-m-d')); ?>" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Départ</label>
                        <input type="date" name="check_out" class="form-control" 
                               value="<?php echo e($checkOut); ?>" min="<?php echo e(now()->addDay()->format('Y-m-d')); ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="adults" class="form-select">
                            <?php for($i = 1; $i <= 10; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e($adults == $i ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i == 1 ? 'Adulte' : 'Adultes'); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="room_type_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type->id); ?>" <?php echo e($roomTypeId == $type->id ? 'selected' : ''); ?>><?php echo e($type->name); ?></option>
                ...
                <div class="search-actions">
                    ...
                    <a href="<?php echo e(route('availability.search')); ?>" class="btn btn-gray">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-8">
            <div class="results-count anim-4">
                <span class="count-badge"><?php echo e(count($availableRooms)); ?> disponible(s)</span>
                <span class="count-text">sur <?php echo e(count($availableRooms) + count($unavailableRooms)); ?> chambres</span>
                <span class="count-badge count-badge-red" style="margin-left: auto;"><?php echo e($nights); ?> nuit(s)</span>
            </div>
        </div>
        <div class="col-md-4">
                ...
                <div class="room-card available">
                    ...
                    <div class="room-card-body">
                        <div class="room-feature">
                            <i class="fas fa-users"></i> Capacité: <strong><?php echo e($roomData['room']->capacity); ?> personnes</strong>
                        </div>
                        <div class="room-feature">
                            <i class="fas fa-bed"></i> Type: <strong><?php echo e($roomData['room']->type->name ?? 'Standard'); ?></strong>
                        </div>
                        <?php if($roomData['room']->surface): ?>
                        <div class="room-feature">
                            <i class="fas fa-arrows-alt"></i> Surface: <strong><?php echo e($roomData['room']->surface); ?> m²</strong>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="room-card-footer">
                        <a href="<?php echo e(route('availability.room.detail', $roomData['room']->id)); ?>" class="btn-room btn-room-gray">
        ...
        <div class="mt-4">
            ...
            <div class="room-grid">
                ...
                <div class="room-card unavailable">
                    ...
                    <div class="room-card-body">
                        <div class="room-feature">
                            <i class="fas fa-users"></i> Capacité: <strong><?php echo e($room->capacity); ?> personnes</strong>
                        </div>
                        <div class="room-feature">
                            <i class="fas fa-bed"></i> Type: <strong><?php echo e($room->type->name ?? 'Standard'); ?></strong>
                        </div>
                        ...
                        <div class="conflict-info">
                            <div class="conflict-header">
                                ...
                                <span class="conflict-count"><?php echo e(count($roomConflicts[$room->id])); ?></span>
                            </div>
                            <div class="conflict-details">
                                ...
                                <div class="conflict-item">
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        ...
                                        <span class="status-badge <?php echo e(str_contains($statusClass, 'success') ? 'active' : 'reservation'); ?>"><?php echo e($statusLabel); ?></span>
                                    </div>
                    ...
                    <div class="room-card-footer">
                        <a href="<?php echo e(route('availability.room.detail', $room->id)); ?>" class="btn-room btn-room-gray">
                            <i class="fas fa-eye"></i> Détails
                        </a>
                        <a href="<?php echo e(route('availability.room.conflicts', $room->id)); ?>?check_in=<?php echo e(request('check_in')); ?>&check_out=<?php echo e(request('check_out')); ?>" 
