...
<div class="show-page">
    ...
    <div class="show-header anim-1">
        ...
        <div class="breadcrumb">
            ...
            <span class="sep"><i class="fas fa-chevron-right fa-xs"></i></span>
            <span class="active">#<?php echo e($cashierSession->id); ?></span>
        </div>
    </div>
        ...
        <div class="session-info">
            ...
            <div class="session-title">
                ...
                <div class="d-flex gap-2 mt-1">
                    <span class="session-badge <?php echo e($cashierSession->status == 'active' ? 'badge-green' : 'badge-gray'); ?>">
                        <?php echo e($cashierSession->status == 'active' ? 'Active' : 'Fermée'); ?>

                    </span>
                    <small class="text-muted">
                        <i class="fas fa-user me-1" style="color:var(--green-600);"></i>
                        <?php echo e($cashierSession->user->name); ?>
    ...
    <div class="stats-grid anim-3">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($cashierSession->start_time->format('d/m/Y')); ?></div>
            <div class="stat-sub">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($cashierSession->initial_balance, 0, ',', ' ')); ?></div>
            <div class="stat-sub">FCFA</div>
        </div>

        <div class="stat-card">
            <div class="stat-label">Encaissements</div>
            <div class="stat-value green"><?php echo e(number_format($encaissements, 0, ',', ' ')); ?></div>
            <div class="stat-sub"><?php echo e($paymentCount); ?> paiement(s)</div>
        </div>

        <div class="stat-card">
            <div class="stat-label">Remboursements</div>
            <div class="stat-value red"><?php echo e(number_format($remboursements, 0, ',', ' ')); ?></div>
            <div class="stat-sub"><?php echo e($payments->where('status', 'completed')->where('amount', '<', 0)->count()); ?> tx</div>
        </div>

        <div class="stat-card">
            <div class="stat-label">Net</div>
            <div class="stat-value <?php echo e($netTotal >= 0 ? 'green' : 'red'); ?>"><?php echo e(number_format($netTotal, 0, ',', ' ')); ?></div>
            <div class="stat-sub">FCFA</div>
        </div>

        <div class="stat-card">
            <div class="stat-label">Solde final</div>
            <div class="stat-value <?php echo e(($netTotal + $cashierSession->initial_balance) >= 0 ? 'green' : 'red'); ?>">
                <?php echo e(number_format($netTotal + $cashierSession->initial_balance, 0, ',', ' ')); ?>

            </div>
            <?php if($difference != 0): ?>
            <div class="stat-diff <?php echo e($difference > 0 ? 'green' : 'red'); ?>">
                <i class="fas <?php echo e($difference > 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?>"></i>
                Écart: <?php echo e(number_format(abs($difference), 0, ',', ' ')); ?>
    ...
    <div class="table-card">
        <div class="table-card-header">
            ...
            <span class="badge <?php echo e($payments->count() > 0 ? 'badge-green' : 'badge-gray'); ?>" style="margin-left:auto;">
                <?php echo e($payments->count()); ?> transaction(s)
            </span>
        </div>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><span style="font-family:var(--mono);">#<?php echo e($payment->reference); ?></span></td>
                        <td>
                        ...
                        <td>
                            <?php if($payment->transaction && $payment->transaction->customer): ?>
                                <div class="fw-semibold"><?php echo e($payment->transaction->customer->name); ?></div>
                                <small class="text-muted"><?php echo e($payment->transaction->customer->phone ?? ''); ?></small>
                            <?php else: ?>
                                <span class="text-muted">N/A</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <span class="amount <?php echo e($isPositive ? 'green' : 'red'); ?>">
                                <?php echo e($isPositive ? '+' : '-'); ?> <?php echo e(number_format(abs($payment->amount), 0, ',', ' ')); ?> FCFA
                            </span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="status-badge status-<?php echo e($payment->status); ?>">
                                <?php echo e($payment->status == 'completed' ? '✓ Complété' : '⏱ En attente'); ?>

                            </span>
                        </td>
                        <td class="text-center">
                            <a href="<?php echo e(route('payment.show', $payment)); ?>" class="btn-icon" title="Voir détails">
                ...
                <div class="modal-body">
                    ...
                    <div class="summary-box">
                        <div class="summary-row">
                            ...
                            <span class="fw-bold"><?php echo e(number_format($cashierSession->initial_balance, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                        <div class="summary-row">
                            <span>Encaissements</span>
                            <span class="fw-bold green"><?php echo e(number_format($encaissements, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                        <div class="summary-row">
                            <span>Remboursements</span>
                            <span class="fw-bold red"><?php echo e(number_format($remboursements, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                        <div class="summary-row">
                            <span>Solde théorique</span>
                            <span class="fw-bold"><?php echo e(number_format($netTotal + $cashierSession->initial_balance, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="final_balance" class="form-control" 
                               step="0.01" value="<?php echo e($netTotal + $cashierSession->initial_balance); ?>" required>
...
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/cashier/sessions/show.blade.php ENDPATH**/ ?>