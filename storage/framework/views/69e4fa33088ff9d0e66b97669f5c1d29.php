...
<body>
    ...
    <nav class="navbar navbar-expand-lg cp-navbar fixed-top" id="mainNavbar">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('frontend.home')); ?>">
                <img src="<?php echo e(asset('img/logo_cactus.png')); ?>" alt="Hôtel Cactus Palace"
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('frontend.home') ? 'active' : ''); ?>"
                           href="<?php echo e(route('frontend.home')); ?>">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('frontend.rooms*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('frontend.rooms')); ?>">Chambres &amp; Suites</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('frontend.restaurant*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('frontend.restaurant')); ?>">Restaurant</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('frontend.services*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('frontend.services')); ?>">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('frontend.contact*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('frontend.contact')); ?>">Contact</a>
                    </li>
    ...
    <footer class="footer pt-5 pb-0 mt-5">
        <div class="container">
            <div class="row gy-4 text-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center justify-content-center gap-2 mb-3">
                        <img src="<?php echo e(asset('img/logo_cactus.png')); ?>" alt="Cactus Palace" style="height:40px;filter:brightness(10)">
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    <h5>Navigation</h5>
                    <a href="<?php echo e(route('frontend.home')); ?>" class="footer-link">Accueil</a>
                    <a href="<?php echo e(route('frontend.rooms')); ?>" class="footer-link">Chambres &amp; Suites</a>
                    <a href="<?php echo e(route('frontend.restaurant')); ?>" class="footer-link">Restaurant</a>
                    <a href="<?php echo e(route('frontend.services')); ?>" class="footer-link">Services</a>
                    <a href="<?php echo e(route('frontend.contact')); ?>" class="footer-link">Contact</a>
                    <a href="<?php echo e(route('frontend.reservation')); ?>" class="footer-link">Réservation</a>
                </div>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center pb-4 footer-bottom">
                <p class="mb-1 mb-sm-0">&copy; <?php echo e(date('Y')); ?> Cactus Palace · Haie Vive, Cotonou. Tous droits réservés.</p>
...
</html><?php /**PATH C:\Users\HP\HotelManagement\resources\views/frontend/layouts/master.blade.php ENDPATH**/ ?>