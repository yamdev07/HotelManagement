    ...
    <div class="report-card">
        ...
        <div class="report-header">
            <div class="header-title">
                <h1>Rapport de Session <em>#<?php echo e($session->id); ?></em></h1>
                <p>
        ...
        <div class="kpi-grid">
            <div class="kpi-card">
                ...
                <div class="kpi-footer">
                    <span>FCFA</span>
                    <span class="kpi-badge green"><?php echo e($paymentCount); ?> paiements</span>
                </div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value" style="color: var(--red-500);"><?php echo e(number_format($totalRefunded, 0, ',', ' ')); ?></div>
                <div class="kpi-footer">
                    <span>FCFA</span>
                </div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value <?php echo e($netTotal >= 0 ? 'green' : 'red'); ?>"><?php echo e(number_format($netTotal, 0, ',', ' ')); ?></div>
                <div class="kpi-footer">
        ...
        <div class="methods-grid">
            ...
            <div class="method-card">
                ...
                <div class="method-stats">
                    <span class="method-amount <?php echo e(!$isPositive ? 'red' : ''); ?>">
                        <?php echo e($isPositive ? number_format($method['total'], 0, ',', ' ') : '-' . number_format(abs($method['total']), 0, ',', ' ')); ?>

                    </span>
                    <span class="method-count"><?php echo e($method['count']); ?> tx</span>
                </div>
                <div class="method-progress">
                    <div class="method-progress-bar" style="width: <?php echo e($percentage); ?>%"></div>
                </div>
            </div>
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><span style="font-family: var(--mono);"><?php echo e(substr($payment->reference, -8)); ?></span></td>
                            ...
                            <td>
                                <span class="amount <?php echo e($isPositive ? 'positive' : 'negative'); ?>">
                                    <?php echo e($isPositive ? '+' : '-'); ?> <?php echo e(number_format(abs($payment->amount), 0, ',', ' ')); ?>

                                </span>
                            </td>
                            <td>
                                <span class="badge <?php echo e($isCompleted ? 'green' : ''); ?>">
            ...
            <div class="table-footer">
                <div class="table-totals">
                    <div>
                        ...
                        <span class="total-value"><?php echo e($paymentCount); ?></span>
                    </div>
                    <div>
                        <span class="total-label">Encaissé</span>
                        <span class="total-value green"><?php echo e(number_format($totalCompleted, 0, ',', ' ')); ?></span>
                    </div>
                    <div>
                        <span class="total-label">Remboursé</span>
                        <span class="total-value red"><?php echo e(number_format($totalRefunded, 0, ',', ' ')); ?></span>
                    </div>
                    <div>
                        <span class="total-label">Net</span>
                        <span class="total-value <?php echo e($netTotal >= 0 ? 'green' : 'red'); ?>"><?php echo e(number_format($netTotal, 0, ',', ' ')); ?></span>
                    </div>
                </div>
                <div>
                    <span class="badge green">✓ <?php echo e($payments->where('status', 'completed')->count()); ?></span>
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                ...
                <div class="summary-value green"><?php echo e(number_format($totalCompleted, 0, ',', ' ')); ?></div>
            </div>
            
            <div class="summary-item">
                <div class="summary-label">Total remboursé</div>
                <div class="summary-value red"><?php echo e(number_format($totalRefunded, 0, ',', ' ')); ?></div>
            </div>
            
            <div class="summary-item">
                <div class="summary-label">Solde final</div>
                <div class="summary-value <?php echo e($netTotal >= 0 ? 'green' : 'red'); ?>"><?php echo e(number_format($netTotal + $session->initial_balance, 0, ',', ' ')); ?></div>
            </div>
        </div>
        ...
        <div class="report-footer">
            ...
            <div class="footer-actions">
                <a href="<?php echo e(route('cashier.sessions.show', $session)); ?>" class="btn btn-gray">
