...
<div class="cal-topbar">
    <div class="cal-topbar__inner">
        ...
        <div class="cal-topbar__actions">
            ...
            <a href="<?php echo e(route('availability.search')); ?>" class="btn btn--primary">
...
<div class="cal-kpis">
    ...
    <div class="kpi-card">
        ...
        <div>
            ...
            <div class="kpi-value" style="color:var(--grn)"><?php echo e($stats['available_today']); ?></div>
        </div>
    </div>
    <div class="kpi-card">
        ...
        <div>
            ...
            <div class="kpi-value" style="color:var(--yel)"><?php echo e($stats['occupied_today']); ?></div>
        </div>
    </div>
    <div class="kpi-card">
        ...
        <div>
            ...
            <div class="kpi-value" style="color:var(--red)"><?php echo e($stats['unavailable_today']); ?></div>
        </div>
    </div>
</div>
        ...
        <form method="GET" id="calendarFilterForm">
            <div class="filter-grid">
                ...
                <div class="filter-actions">
                    ...
                    <a href="<?php echo e(route('availability.calendar')); ?>" class="btn btn--outline">
                    ...
                    <tr>
                        ...
                        <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateString => $dateInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <th class="date-col <?php echo e($dateInfo['is_today'] ? 'th-today' : ''); ?> <?php echo e($dateInfo['is_weekend'] ? 'th-weekend' : ''); ?>"
                                ...
                                onclick="scrollToDate('<?php echo e($dateString); ?>')"
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $calendar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roomData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="room-row" data-room-number="<?php echo e($roomData['room']->number); ?>">
                                <td class="room-cell">
                                ...
                                <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateString => $dateInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <td class="avail-cell <?php echo e($cssClass); ?> <?php echo e($dateInfo['is_today'] ? 'today' : ''); ?> <?php echo e($dateInfo['is_weekend'] ? 'weekend' : ''); ?>"
                                        ...
                                        title="<?php echo e($dateInfo['date']->format('d/m/Y')); ?> - Chambre <?php echo e($roomData['room']->number); ?> - <?php echo e($isOccupied ? 'Occupée' : 'Disponible'); ?>">
                                        <?php if($isOccupied): ?>
