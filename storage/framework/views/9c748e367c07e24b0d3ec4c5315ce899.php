            ...
            <nav class="nav-menu">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('dashboard.index')); ?>"
                       class="nav-item <?php echo e($activeClass('dashboard.index')); ?>" data-tooltip="Dashboard">
                    ...
                    <?php if(in_array(auth()->user()->role, ['Super', 'Admin', 'Receptionist'])): ?>
                        ...
                        <a href="<?php echo e(route('availability.dashboard')); ?>"
                           class="nav-item <?php echo e($activeClass('availability.', false)); ?>" data-tooltip="Disponibilité">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('checkin.index')); ?>"
                       class="nav-item nav-item--highlight <?php echo e($isCheckinActive ? 'active' : ''); ?>" data-tooltip="Check-in/out">
                    ...
                    <a href="<?php echo e(route('transaction.reservation.createIdentity')); ?>"
                       class="nav-item nav-item--highlight <?php echo e($activeClass('transaction.reservation.createIdentity')); ?>" data-tooltip="Nouvelle Réservation">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('transaction.index')); ?>"
                       class="nav-item <?php echo e(($activeClass('transaction.', false) && !str_contains($currentRoute, 'transaction.reservation.')) ? 'active' : ''); ?>" data-tooltip="Liste Clients">
                    ...
                    <a href="<?php echo e(route('cashier.dashboard')); ?>"
                       class="nav-item <?php echo e($activeClass('cashier.', false)); ?>" data-tooltip="Caisse">
                    ...
                    <a href="<?php echo e(route('restaurant.index')); ?>"
                       class="nav-item <?php echo e($activeClass('restaurant.', false)); ?>" data-tooltip="Restaurant">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('customer.index')); ?>"
                       class="nav-item <?php echo e($activeClass('customer.index')); ?>" data-tooltip="Clients">
                    ...
                    <a href="<?php echo e(route('room.index')); ?>"
                       class="nav-item <?php echo e($activeClass('room.index')); ?>" data-tooltip="Chambres">
                    ...
                    <a href="<?php echo e(route('type.index')); ?>"
                       class="nav-item restricted <?php echo e($activeClass('type.index')); ?>" data-tooltip="Types Chambres">
                    ...
                    <a href="<?php echo e(route('payments.index')); ?>"
                       class="nav-item <?php echo e($isPaymentActive ? 'active' : ''); ?>" data-tooltip="Paiements">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('housekeeping.dashboard')); ?>"
                       class="nav-item <?php echo e($activeClass('housekeeping.', false)); ?>" data-tooltip="Housekeeping">
                    ...
                    <?php if(Route::has('checkin.index') && in_array(auth()->user()->role, ['Housekeeping'])): ?>
                    <?php
                        $isCheckinActive = in_array($currentRoute, [
                            'checkin.index','checkin.search','checkin.show',
                            'checkin.direct','checkin.process-direct-checkin',
                    ...
                    ?>
                    <a href="<?php echo e(route('checkin.index')); ?>"
                       class="nav-item nav-item--readonly <?php echo e($isCheckinActive ? 'active' : ''); ?>"
                    ...
                    <a href="<?php echo e(route('roomstatus.index')); ?>"
                       class="nav-item <?php echo e($activeClass('roomstatus.index')); ?>" data-tooltip="Statuts">
                    ...
                    <a href="<?php echo e(route('facility.index')); ?>"
                       class="nav-item <?php echo e($activeClass('facility.index')); ?>" data-tooltip="Équipements">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('user.index')); ?>"
                       class="nav-item restricted <?php echo e($activeClass('user.index')); ?>" data-tooltip="Utilisateurs">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>"
                       class="nav-item <?php echo e($activeClass('reports.index')); ?>" data-tooltip="Rapports">
                    ...
                    <a href="<?php echo e(route('activity.index')); ?>"
                       class="nav-item <?php echo e($activeClass('activity.index')); ?>" data-tooltip="Journal">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('profile.index')); ?>"
                       class="nav-item <?php echo e($activeClass('profile.', false)); ?>" data-tooltip="Profil">
                    ...
                    <a href="<?php echo e(route('transaction.myReservations')); ?>"
                       class="nav-item <?php echo e($activeClass('transaction.myReservations')); ?>" data-tooltip="Mes Réservations">
                    ...
                    <a href="<?php echo e(route('notification.index')); ?>"
                       class="nav-item <?php echo e($activeClass('notification.index')); ?>" data-tooltip="Notifications">
                        <div class="nav-icon">
                    ...
                    <a href="<?php echo e(route('receptionist.session.active')); ?>"
                       class="nav-item <?php echo e($activeClass('receptionist.session.', false)); ?>" data-tooltip="Ma Session">
                    ...
                    <div class="nav-item nav-item--logout"
                         onclick="if(typeof Swal!=='undefined'){Swal.fire({title:'⚠️ Session Active',html:'Vous avez une session active <strong>#<?php echo e($activeSession->id); ?></strong>.<br><br>Veuillez la clôturer avant de vous déconnecter.',icon:'warning',confirmButtonColor:'#1e6b2e',confirmButtonText:'Compris',showCancelButton:true,cancelButtonText:'Aller à la session',cancelButtonColor:'#545954'}).then(r=>{if(r.dismiss===Swal.DismissReason.cancel)window.location.href='<?php echo e(route("cashier.sessions.show", $activeSession)); ?>';});}else{alert('Session active. Clôturez d\'abord.');}"
        ...
        <div class="sidebar-footer">
            <div class="user-profile">
                <div class="user-avatar">
                    ...
                    ?>
                    <?php if($avatarPath): ?>
                        <img src="<?php echo e($avatarPath); ?>" alt="<?php echo e(auth()->user()->name); ?>"
                             onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=1e6b2e&color=fff&size=40';">
                    <?php else: ?>
                ...
                <div class="user-info">
                    ...
                    <div class="user-role-badge">
                        <?php switch(auth()->user()->role):
                            case ('Super'): ?>    <span class="role-pill role-super">Super Admin</span><?php break; ?>
                            <?php case ('Admin'): ?>    <span class="role-pill role-admin">Administrateur</span><?php break; ?>
                            <?php case ('Receptionist'): ?> <span class="role-pill role-recep">Réceptionniste</span><?php break; ?>
                            <?php case ('Housekeeping'): ?> <span class="role-pill role-house">Femme de Chambre</span><?php break; ?>
                            <?php case ('Customer'): ?> <span class="role-pill role-cust">Client</span><?php break; ?>
                            <?php default: ?>          <span class="role-pill role-other"><?php echo e(auth()->user()->role); ?></span>
                        <?php endswitch; ?>
                    </div>
                    <?php if($hasActiveSession): ?>
                    <div class="session-dot">
                        <span class="dot-live"></span>
                        <small>Session #<?php echo e($activeSession->id); ?></small>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
</script><?php /**PATH C:\Users\HP\HotelManagement\resources\views/template/include/_sidebar.blade.php ENDPATH**/ ?>