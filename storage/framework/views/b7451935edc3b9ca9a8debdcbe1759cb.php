<header class="mobile-header">
    <div class="mh-inner">
        ...
        <a href="<?php echo e(route('dashboard.index')); ?>" class="mh-brand">
        ...
        <div class="mh-right">
            ...
            <div class="dropdown">
                <button class="mh-icon-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Notifications">
                    ...
                    <span class="mh-notif-dot"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
                    <?php endif; ?>
                </button>
                <div class="dropdown-menu dropdown-menu-end mh-dropdown-notif shadow-lg">
                    <div class="mh-dd-head">
                        ...
                        <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                        <span class="mh-dd-badge"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="mh-notif-list">
                        <?php $__empty_1 = true; $__currentLoopData = auth()->user()->unreadNotifications->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('notification.routeTo', ['id' => $notification->id])); ?>" class="mh-notif-item">
                            <div class="mh-notif-ico"><i class="fas fa-bell"></i></div>
                            <div class="mh-notif-body">
                                <div class="mh-notif-msg"><?php echo e(Str::limit($notification->data['title'] ?? 'Nouvelle notification', 42)); ?></div>
                                <div class="mh-notif-time"><?php echo e($notification->created_at->diffForHumans()); ?></div>
                            </div>
                        </a>
                    ...
                    <?php if(auth()->user()->unreadNotifications->count() > 4): ?>
                    <a href="<?php echo e(route('notification.index')); ?>" class="mh-dd-footer">
                        Voir tout (<?php echo e(auth()->user()->unreadNotifications->count()); ?>)
                    </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="dropdown">
                <button class="mh-profile-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="mh-profile-info d-none d-sm-block">
                        <div class="mh-profile-name"><?php echo e(auth()->user()->name); ?></div>
                        <div class="mh-profile-role"><?php echo e(auth()->user()->role ?? 'Admin'); ?></div>
                    </div>
                ...
                <div class="dropdown-menu dropdown-menu-end mh-dropdown-profile shadow-lg">
                    <div class="mh-dd-head mh-dd-head--profile">
                        <div class="mh-avatar mh-avatar--sm"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 2))); ?></div>
                        <div>
                            <div class="mh-dd-user-name"><?php echo e(auth()->user()->name); ?></div>
                            <div class="mh-dd-user-role"><?php echo e(auth()->user()->role ?? 'Admin'); ?></div>
                        </div>
                    </div>
                    <div class="mh-dd-divider"></div>
                    <?php if(Route::has('profile.index')): ?>
                    <a class="mh-dd-item" href="<?php echo e(route('profile.index')); ?>">
                        <i class="fas fa-user"></i> Mon Profil
                    </a>
                    <?php endif; ?>
                    <?php if(Route::has('notification.index')): ?>
                    <a class="mh-dd-item" href="<?php echo e(route('notification.index')); ?>">
                    ...
                    <form id="mh-logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none"><?php echo csrf_field(); ?></form>
                </div>
            </div>
...
</style><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/template/include/_mobile-header.blade.php ENDPATH**/ ?>