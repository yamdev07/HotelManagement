...
<div class="sessions-page">
    ...
    <div class="stats-grid anim-2">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value stat-value-green"><?php echo e($activeSessions); ?></div>
            <div class="stat-subtitle">En cours</div>
        </div>
        
        <div class="stat-card">
            <div class="stat-label">Chiffre d'affaires</div>
            <div class="stat-value stat-value-green"><?php echo e(number_format($totalRevenue, 0, ',', ' ')); ?></div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $mins = $duration->i;
                    ?>
                    <tr onclick="window.location='<?php echo e(route('cashier.sessions.show', $session)); ?>'">
                        <td><strong>#<?php echo e($session->id); ?></strong></td>
                        <td>
                            <div class="user-info">
                                <div class="user-avatar">
                                    <?php if($session->user && $session->user->getAvatar()): ?>
                                        <img src="<?php echo e($session->user->getAvatar()); ?>" alt="">
                                    <?php else: ?>
                        ...
                        <td>
                            <span class="badge badge-gray">
                                <?php echo e($hours); ?>h <?php echo e($mins); ?>min
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="amount <?php echo e($difference > 0 ? 'amount-green' : ($difference < 0 ? 'amount-red' : '')); ?>">
