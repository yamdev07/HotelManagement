...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('facility.create')); ?>" class="btn btn-success">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('facility.edit', $facility->id)); ?>" class="btn btn-sm btn-primary">
                            ...
                            <form id="delete-facility-form-<?php echo e($facility->id); ?>" 
