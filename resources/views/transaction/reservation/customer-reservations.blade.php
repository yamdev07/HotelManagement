                    ...
                    <div style="overflow-x:auto;">
                        <table class="history-table">
                            ...
                            <tbody>
                                ...
                                @endphp
                                <tr>
                                    <td class="fw-bold" style="font-family:var(--mono); color:var(--s800);">#{{ $reservation->id }}</td>
                                    <td>
                                        <div class="room-info">
                                    ...
                                    <td>
                                        <span class="status-badge {{ $statusClass }}">
                                            <i class="fas fa-{{ $reservation->status_icon }}"></i>
                                    ...
                                    <td>
                                        <div class="payment-progress">
                                            <div class="progress-bar-container">
                                                <div class="progress-fill {{ $percentage >= 100 ? 'progress-fill-success' : 'progress-fill-warning' }}" 
                                                     style="width: {{ $percentage }}%"></div>
                                            </div>
                                            <div class="payment-text">{{ $percentage }}%</div>
                                    ...
                                    <td>
                                        <span class="date-created">{{ $reservation->created_at->format('d/m/Y H:i') }}</span>
                                    </td>
                                    <td>
