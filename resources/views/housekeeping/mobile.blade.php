...
<div class="mobile-page">
    ...
    <div class="mobile-header">
        <div class="header-top">
            ...
            <div class="header-actions">
                <a href="{{ route('housekeeping.index') }}" class="btn-icon"><i class="fas fa-desktop"></i></a>
                <a href="{{ route('housekeeping.scan') }}" class="btn-icon"><i class="fas fa-qrcode"></i></a>
            </div>
        </div>
    ...
    <div class="section">
        ...
        <div class="side-item">
            <div class="side-header">
                <div class="side-room">#{{ $d->room->number }}</div>
                <div class="side-badge red"><i class="fas fa-clock"></i> 12h00</div>
            </div>
            <div class="side-info">
                <span class="side-name">{{ $d->customer->name ?? 'Client' }}</span>
                <span class="side-time"><i class="fas fa-bed"></i> {{ $d->room->type->name ?? 'Standard' }}</span>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="section">
        ...
        @php $dur = \Carbon\Carbon::parse($room->cleaning_started_at ?? now())->diffForHumans(now(), true); @endphp
    ...
    <div class="section">
        ...
        <div class="side-item">
            <div class="side-header">
                <div class="side-room">#{{ $a->room->number }}</div>
                <div class="side-badge green"><i class="fas fa-clock"></i> 14h00</div>
            </div>
            <div class="side-info">
                <span class="side-name">{{ $a->customer->name ?? 'Client' }}</span>
                <span class="side-time"><i class="fas fa-bed"></i> {{ $a->room->type->name ?? 'Standard' }}</span>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="reason-tags">
        ...
        <span class="reason-tag">{{ $reason }}: {{ $count }}</span>
        @endforeach
    </div>
    @endif
