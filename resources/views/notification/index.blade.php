    ...
    <div class="notif-toolbar anim-2">
        ...
        <div class="notif-filters" id="notifFilters">
            ...
            <button type="button" class="notif-filter" data-filter="new">
                <i class="fas fa-circle" style="font-size:.5rem;"></i> {{ __('notification.unread_section') }} <span class="count">{{ $newCount }}</span>
            </button>
            <button type="button" class="notif-filter" data-filter="read">
                <i class="fas fa-check"></i> {{ __('notification.read_section') }} <span class="count">{{ $readCount }}</span>
            </button>
        </div>
    </div>
