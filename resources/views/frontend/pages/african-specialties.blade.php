...
@section('title', 'Spécialités Africaines — Cactus Palace 5 Étoiles')
    ...
    <div class="container">
        ...
        <div class="africa-section-header" data-aos="fade-up">
            ...
            <p class="section-subtitle">
                ...
                Découvrez notre sélection de {{ $menus->count() }} spécialités africaines.
            </p>
        </div>
            ...
            @else
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        @include('frontend.partials.african-card', ['menu' => $menu])
                    </div>
                    @endforeach
                </div>
            @endif
    ...
    <div class="container text-center">
        <div data-aos="fade-up">
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <a href="{{ route('frontend.restaurant') }}#reservationSection" class="btn-cta-gold">
                    <i class="fas fa-calendar-check"></i> Réserver une table
                </a>
                <a href="{{ route('frontend.restaurant') }}#menuSection" class="btn-cta-outline">
