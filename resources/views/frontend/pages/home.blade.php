                ...
                <div class="row min-vh-100 align-items-center justify-content-center">
                    <div class="col-lg-10 text-center">
                        ...
                        <div class="hero-cta" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <a href="{{ route('frontend.contact') }}" class="btn-modern btn-outline">
                                Réserver maintenant
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                    <div class="room-card-modern">
                        ...
                        <div class="room-details">
                            ...
                            <p class="room-description">{{ Str::limit($room->short_description, 100) }}</p>
                            @endif
    ...
    bookingForms.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            if (arrivalInput && departureInput) {
                ...
                // window.location.href = '{{ route("frontend.rooms") }}?arrival=' + arrivalInput.value + '&departure=' + departureInput.value;
            }
        });
    });
});
