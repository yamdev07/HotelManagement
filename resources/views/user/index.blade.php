...
<div class="users-page">
    ...
    <div class="stats-grid fade-in">
        ...
        <div class="stat-card-modern success stagger-2">
            ...
            <div class="stat-footer">
                ...
                {{ $adminCount }} admin, {{ $staffCount }} staff
            </div>
        </div>
    ...
    <div class="action-bar fade-in">
        <div class="action-left">
            <a href="{{ route('user.create') }}" class="btn-modern btn-primary-modern">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="rounded-circle bg-{{ $user->role == 'Admin' ? 'warning' : 'primary' }} bg-opacity-10 p-2" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
                                                        <i class="fas fa-{{ $user->role == 'Admin' ? 'crown' : 'user' }} text-{{ $user->role == 'Admin' ? 'warning' : 'primary' }}" style="font-size: 0.875rem;"></i>
                                                    </div>
