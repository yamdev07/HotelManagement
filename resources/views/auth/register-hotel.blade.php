                    ...
                    <form action="{{ route('hotel.register.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="tel" name="contact_phone" class="form-control form-control-lg @error('contact_phone') is-invalid @enderror" value="{{ old('contact_phone') }}" placeholder="+229 01 02 03 04" pattern="[0-9+\s().\-]{6,20}" maxlength="20" inputmode="tel">
