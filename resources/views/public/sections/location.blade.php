...
<section class="section" id="localisation">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="eyebrow mb-2">{{ __('public.location_find') }}</div>
            <h2 class="display-serif" style="font-size:clamp(2rem,4vw,3.2rem);">{{ __('public.location_title') }}</h2>
        ...
        <div class="row g-4 align-items-stretch">
            <div class="col-lg-5" data-aos="fade-right">
                <div style="background:var(--card);border:1px solid var(--line);border-radius:8px;padding:2rem;height:100%;">
                    <div class="d-flex align-items-start gap-3 mb-4">
                        ...
                        <div>
                            <div class="eyebrow mb-1" style="color:var(--ink);opacity:.6;">{{ __('public.location_address') }}</div>
                    ...
                    <a href="https://www.google.com/maps/dir/?api=1&destination={{ urlencode($hotel->address) }}" target="_blank" rel="noopener" class="btn-c">
                        <i class="fas fa-diamond-turn-right me-2"></i>{{ __('public.location_directions') }}
                    </a>
                </div>
            </div>
            <div class="col-lg-7" data-aos="fade-left" data-aos-delay="120">
                <div style="border-radius:8px;overflow:hidden;box-shadow:0 20px 50px -30px rgba(0,0,0,.4);height:100%;min-height:340px;">
                    <iframe title="{{ __('public.location_map_title') }}" width="100%" height="100%" style="border:0;min-height:340px;display:block;"
